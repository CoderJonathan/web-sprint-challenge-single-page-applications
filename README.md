...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    React's `useRouteMatch` hook is used to determine if the url matches a given stream without having to render a route component. Basically a true or false rather than wasting resources rendering the entire component.

1. How would you explain form validation to someone who has never programmed before?

    Validation tells the user to fill in required fields to complete a form and prohibits them from proceeding if requirements aren't met.

1. In 1-2 sentences, define end to end testing.

    End to end testing is testing the entire application from beginning to end to make sure the application flow is behaving as expected. (end to end)
