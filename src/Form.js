        ...
        <form onSubmit = {formSubmit}>
            ...
            <label htmlFor = 'size'>
                ...
                <select name = 'size' id = 'sizeinput' onChange = {inputChange}>
                    ...
                    <option name="Small" value='Sm'>Small</option>
                    <option name="Medium" value='Md'>Medium</option>
                    <option name="Large" value='Lg'>Large</option>
                    <option name="Xtra-Large" value='XL'>Xtra-Large</option>
                </select>
            </label>
            <br/>
